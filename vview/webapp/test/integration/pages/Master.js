		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "Collaborationtype (0)"
						}),
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'Collaborationtype (0)'");
						},
				...
				theListShouldBeSortedAscendingOnUnitNumber: function () {
					return this.theListShouldBeSortedAscendingOnField("state");
				},
				...
				theListShouldHaveAllEntries: function () {
					...
					// retrieve all Collaborationtype to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "Collaborationtype (" + iExpectedLength + ")"
								}),
								success: function () {
