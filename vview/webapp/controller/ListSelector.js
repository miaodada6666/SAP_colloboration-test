sap.ui.define([
	...
	return BaseObject.extend("my.bookshop.vview.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias my.bookshop.vview.model.ListSelector
		 */
		 ...
		 * @return {my.bookshop.vview.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
