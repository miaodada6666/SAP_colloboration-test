/*global history */
sap.ui.define([
	"my/bookshop/vview/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"my/bookshop/vview/model/formatter",
	"sap/m/MessageBox",
	"my/bookshop/vview/model/grouper",
	...
	return BaseController.extend("my.bookshop.vview.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("my.bookshop.vview.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("state", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("state", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							...
							version: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("version"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				...
				version: encodeURIComponent(oItem.getBindingContext().getProperty("version"))
			}, bReplace);
		},
