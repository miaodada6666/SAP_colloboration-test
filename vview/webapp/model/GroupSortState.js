sap.ui.define([
	...
	return BaseObject.extend("my.bookshop.vview.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias my.bookshop.vview.model.GroupSortState
		 */
		...
		/**
		 * Sorts by description, or by state
		 *
		...
		/**
		 * Groups by state, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "state") {
				...
				this._oViewModel.setProperty("/sortBy", "state");

				aSorters.push(
					new Sorter("state", false,
